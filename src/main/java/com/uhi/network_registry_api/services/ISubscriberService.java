...
public interface ISubscriberService {
	...
	Subscriber addSubscriber (String city, String encr_public_key, String pub_key_id, String signing_public_key, String subscriber_id, String unique_key_id, String sub_type, String url) throws NRAuthException;
